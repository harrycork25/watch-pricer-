...
const WATCH_NICKNAMES: NicknameEntry[] = [
  ...
  { nickname: "No Date Sub",      make: "Rolex", model: "Submariner",            reference: "124060",      material: "Steel",      dial: "Black" },
  ...
  { nickname: "Sprite",           make: "Rolex", model: "GMT-Master II",         reference: "126720VTNR",  material: "Steel",      dial: "Black",   bracelet: "Jubilee" },
  ...
  { nickname: "Steve McQueen GMT",make: "Rolex", model: "GMT-Master",            reference: "1675",        dial: "Black" },
  // ── Rolex Daytona ─────────────────────────────────────────────────────────
  ...
  { nickname: "Rainbow Daytona",  make: "Rolex", model: "Daytona",               reference: "116595RBOW",  material: "Rose Gold" },
  { nickname: "Rainbow",          make: "Rolex", model: "Daytona",               reference: "116595RBOW",  material: "Rose Gold" },
  { nickname: "John Mayer",       make: "Rolex", model: "Day-Date 40",           reference: "228235",      material: "Rose Gold",  dial: "Meteorite" },
  // ── Rolex Oyster Perpetual colours ────────────────────────────────────────
  { nickname: "Olive",            make: "Rolex", model: "Oyster Perpetual 41",   reference: "124300",      material: "Steel",      dial: "Olive Green" },
  { nickname: "Olive OP",         make: "Rolex", model: "Oyster Perpetual 41",   reference: "124300",      material: "Steel",      dial: "Olive Green" },
  { nickname: "Turquoise OP",     make: "Rolex", model: "Oyster Perpetual 36",   reference: "126000",      material: "Steel",      dial: "Turquoise" },
  { nickname: "Turquoise",        make: "Rolex", model: "Oyster Perpetual 36",   reference: "126000",      material: "Steel",      dial: "Turquoise" },
  { nickname: "Candy Pink",       make: "Rolex", model: "Oyster Perpetual 36",   reference: "126000",      material: "Steel",      dial: "Candy Pink" },
  { nickname: "Coral",            make: "Rolex", model: "Oyster Perpetual 36",   reference: "126000",      material: "Steel",      dial: "Coral Red" },
  { nickname: "Tiffany OP",       make: "Rolex", model: "Oyster Perpetual 41",   reference: "124300",      material: "Steel",      dial: "Tiffany Blue" },
  { nickname: "Yellow OP",        make: "Rolex", model: "Oyster Perpetual 41",   reference: "124300",      material: "Steel",      dial: "Yellow" },
  // ── Rolex Datejust ────────────────────────────────────────────────────────
  { nickname: "Wimbledon",        make: "Rolex", model: "Datejust 41",           reference: "126334",      material: "Steel",      dial: "Grey" },
  { nickname: "Confetti",         make: "Rolex", model: "Datejust",              reference: "16013",       dial: "Confetti" },
  { nickname: "Thunderbird",      make: "Rolex", model: "Datejust Turn-O-Graph", reference: "16263",       material: "Rolesor" },
  // ── Rolex Day-Date ────────────────────────────────────────────────────────
  { nickname: "Stella",           make: "Rolex", model: "Day-Date",              reference: "1803",        dial: "Lacquer" },
  { nickname: "President",        make: "Rolex", model: "Day-Date 40",           reference: "228238",      material: "Yellow Gold" },
  // ── Rolex other ───────────────────────────────────────────────────────────
  { nickname: "Deepsea",          make: "Rolex", model: "Sea-Dweller Deepsea",   reference: "126660",      material: "Steel",      dial: "Black" },
  { nickname: "D-Blue",           make: "Rolex", model: "Sea-Dweller Deepsea",   reference: "116660",      material: "Steel",      dial: "D-Blue" },
  { nickname: "Milgauss",         make: "Rolex", model: "Milgauss",              reference: "116400GV",    material: "Steel",      dial: "Green Glass" },
  { nickname: "Polar",            make: "Rolex", model: "Explorer II",           reference: "216570",      material: "Steel",      dial: "White" },
  { nickname: "Air King",         make: "Rolex", model: "Air-King",              reference: "126900",      material: "Steel",      dial: "Black" },
  { nickname: "Albino",           make: "Rolex", model: "Daytona",               reference: "6265",        material: "White Gold", dial: "White" },
  { nickname: "Khanjar",          make: "Rolex", model: "Day-Date",              reference: "18038",       dial: "Khanjar" },
  // ── Patek Philippe ────────────────────────────────────────────────────────
  ...
  { nickname: "Calatrava",        make: "Patek Philippe", model: "Calatrava",    reference: "5196G-010",   material: "White Gold", dial: "White" },
  { nickname: "World Timer",      make: "Patek Philippe", model: "World Time",   reference: "5230G-010",   material: "White Gold", dial: "Blue" },
  // ── Audemars Piguet ───────────────────────────────────────────────────────
  ...
  { nickname: "ROO",              make: "Audemars Piguet", model: "Royal Oak Offshore", reference: "26400SO", material: "Steel" },
  { nickname: "Code 11.59",       make: "Audemars Piguet", model: "Code 11.59", reference: "15210BC",     material: "White Gold" },
  // ── Tudor ─────────────────────────────────────────────────────────────────
  ...
  { nickname: "Snowflake",        make: "Tudor", model: "Submariner",            reference: "9401",        dial: "Black" },
  { nickname: "Tiger",            make: "Tudor", model: "Heritage Chrono",       reference: "70330B",      material: "Steel" },
  // ── Omega ─────────────────────────────────────────────────────────────────
  ...
  { nickname: "Bond",             make: "Omega", model: "Seamaster Professional",reference: "2531.80.00",  material: "Steel",      dial: "Blue" },
  { nickname: "Ploprof",          make: "Omega", model: "Seamaster Ploprof 1200M", reference: "224.32.55.21.01.001" },
  // ── IWC ───────────────────────────────────────────────────────────────────
  { nickname: "Big Pilot",        make: "IWC", model: "Big Pilot",               reference: "IW501001",    material: "Steel",      dial: "Black" },
  { nickname: "Portugieser",      make: "IWC", model: "Portugieser",             reference: "IW500710",    material: "Steel",      dial: "Silver" },
  { nickname: "Portofino",        make: "IWC", model: "Portofino",               reference: "IW356502",    material: "Steel",      dial: "White" },
  { nickname: "Spitfire",         make: "IWC", model: "Pilot Spitfire",          reference: "IW326803",    material: "Steel",      dial: "Black" },
  // ── Breitling ─────────────────────────────────────────────────────────────
  { nickname: "Navitimer",        make: "Breitling", model: "Navitimer",         reference: "AB0121211B1A1", material: "Steel",    dial: "Black" },
  { nickname: "Chronomat",        make: "Breitling", model: "Chronomat",         reference: "AB0134101B1A1", material: "Steel",    dial: "Blue" },
  { nickname: "Superocean",       make: "Breitling", model: "Superocean Heritage", reference: "AB2010121B1S1", material: "Steel", dial: "Blue" },
  // ── TAG Heuer ─────────────────────────────────────────────────────────────
  { nickname: "Monaco",           make: "TAG Heuer", model: "Monaco",            reference: "CAW211P.FC6356", material: "Steel",   dial: "Blue" },
  { nickname: "Carrera",          make: "TAG Heuer", model: "Carrera",           reference: "CBN2A1B.FC6492", material: "Steel",   dial: "Black" },
  // ── Cartier ───────────────────────────────────────────────────────────────
  { nickname: "Santos",           make: "Cartier", model: "Santos de Cartier",   reference: "WSSA0029",    material: "Steel",      dial: "Silver" },
  { nickname: "Tank",             make: "Cartier", model: "Tank Must",            reference: "WSTA0041",    material: "Steel",      dial: "Silver" },
  { nickname: "Tank Francaise",   make: "Cartier", model: "Tank Française",       reference: "W51011Q3",    material: "Steel",      dial: "Silver" },
  { nickname: "Ballon Bleu",      make: "Cartier", model: "Ballon Bleu",         reference: "WSBB0002",    material: "Steel",      dial: "Silver" },
  { nickname: "Panthere",         make: "Cartier", model: "Panthère de Cartier", reference: "WSPN0006",    material: "Steel",      dial: "White" },
  // ── Panerai ───────────────────────────────────────────────────────────────
  { nickname: "Luminor",          make: "Panerai", model: "Luminor Base",        reference: "PAM00002",    material: "Steel",      dial: "Black" },
  { nickname: "Radiomir",         make: "Panerai", model: "Radiomir",            reference: "PAM00210",    material: "Steel",      dial: "Black" },
  { nickname: "PAM111",           make: "Panerai", model: "Luminor Marina",      reference: "PAM00111",    material: "Steel",      dial: "Black" },
  { nickname: "PAM438",           make: "Panerai", model: "Luminor Marina",      reference: "PAM00438",    material: "Steel",      dial: "Black" },
  // ── Jaeger-LeCoultre ──────────────────────────────────────────────────────
  { nickname: "Reverso",          make: "Jaeger-LeCoultre", model: "Reverso Classic", reference: "Q3858522", material: "Steel",   dial: "Silver" },
  { nickname: "Master Control",   make: "Jaeger-LeCoultre", model: "Master Control", reference: "Q4018420",  material: "Steel",   dial: "Silver" },
  // ── Hublot ────────────────────────────────────────────────────────────────
  { nickname: "Big Bang",         make: "Hublot", model: "Big Bang Unico",       reference: "411.NX.1170.RX", material: "Steel",  dial: "Black" },
  { nickname: "Classic Fusion",   make: "Hublot", model: "Classic Fusion",       reference: "542.NX.1170.RX", material: "Steel",  dial: "Black" },
  { nickname: "Spirit of Big Bang", make: "Hublot", model: "Spirit of Big Bang", reference: "601.NX.0173.LR", material: "Steel",  dial: "Black" },
  // ── Richard Mille ─────────────────────────────────────────────────────────
  { nickname: "RM11",             make: "Richard Mille", model: "RM 11-03",      reference: "RM11-03",     material: "Titanium" },
  { nickname: "RM35",             make: "Richard Mille", model: "RM 35-02",      reference: "RM35-02",     material: "NTPT Carbon" },
  { nickname: "RM27",             make: "Richard Mille", model: "RM 27-04",      reference: "RM27-04" },
  { nickname: "RM52",             make: "Richard Mille", model: "RM 52-01",      reference: "RM52-01" },
];
